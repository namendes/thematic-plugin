...
public class ThematicConstants {
  public static final String url = "";
  public static final String SORT_ORDER = "sort";
  public static final String PAGINATION = "page";
  public static final String HIPPO_REF_URL = "hippo:";
  public static final String PROPERTIES_FIELDS = "fields";
  public static final String PROPERTIES_MAX_RESULTS_PER_PAGE = "max_results_per_page";
  public static final String PROPERTIES_ACCOUNT_ID = "account_id";
  public static final String PROPERTIES_DOMAIN_KEY = "domain_key";
